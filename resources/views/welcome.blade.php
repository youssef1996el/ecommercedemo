...
<body >
	...
	<div class="top-header">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6">
					<ul class="top-list">
						{{-- <li><a href="https://bshopen.themeposh.net/order-tracking"><i class="bi bi-geo"></i>Order Tracking</a></li> --}}
						...
						<div class="nav_cat_content">
							<ul class="banner-category-list">
                                @foreach ($Category as $item)
                                    <li>
                                        <a href="{{ url('productByCategory/' . $item->id) }}">{{ $item->name }}</a>
                                    </li>
                                @endforeach
			...
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
						...
						<div class="banner-item-info">
							<h2>New</h2>
							<h4>Collection</h4>
							{{-- <a class="btn theme-btn" href="#">Shop Now</a> --}}
						</div>
					</div>
															<div class="banner-item mb25">
						<div class="banner-item-img">
                ...
                @foreach ($brand as $item)
                    <div class="col-lg-12">
                        <div class="brand-card">
                            <a href="#">
                                <img src="{{ asset('storage/images/' . $item->patch) }}" alt="CA Brand"/>
                            </a>
                        </div>
                    </div>
                @endforeach
                        ...
                        <div class="item-card mb30">
                            <div class="item-image">
                                ...
                                <ul class="product-action">
                                    <li>
                                        <a href="{{ url('DetailProduct/' . $item->id) }}">{{ $item->name }}</a>
                                    ...
                                    <li>
                                        <a class="addtowishlist" data-id="{{$item->id}}" href="javascript:void(0);">
                                        <i class="fa-solid fa-heart"></i>
                                    </a>
                                    </li>
                                </ul>

                                <a href="{{ url('DetailProduct/' . $item->id) }}">
                                    <img src="{{ asset('storage/images/' . $item->image) }}" alt="Yellow (VF1100C V65)"/>
                                </a>
                            </div>
                            <h4 class="item-title">
                                <a href="{{ url('DetailProduct/' . $item->id) }}">{{$item->name}}</a>
	...
	<div class="section">
		<div class="container">
			...
			<div class="row owl-carousel caro-common category-carousel">
                @foreach ($productTrading as $item)
                    <div class="col-lg-12">
                        <div class="item-card mb30">
                            <div class="item-image">
                                <ul class="product-action">
                                ...
                                <a href="{{ url('DetailProduct/' . $item->id) }}">
                                    <img src="{{ asset('storage/images/' . $item->image) }}" alt="{{$item->name}}"/></a>
                            </div>
                            <h4 class="item-title">
                                <a href="{{ url('DetailProduct/' . $item->id) }}">{{$item->name}}</a></h4>
                            <div class="brand-card">
                                <div class="brand">
                                    <span>Brand <a href="#">{{$item->brand}}</a></span>
                                </div>
		...
		<div class="container">
			<div class="row">
				<div class="section-heading">
					...
					{{-- <a class="btn theme-btn seeall-btn" href="https://bshopen.themeposh.net/best-sellers">See all</a> --}}
				</div>
			</div>
			<div class="row owl-carousel caro-common category-carousel">
                    ...
                    <div class="col-lg-12">
                        <div class="item-card mb30">
                            <div class="item-image">
                                ...
                                <a href="{{ url('DetailProduct/' . $item->id) }}"><img src="{{ asset('storage/images/' . $item->image) }}" alt="WiFi Drone and HD camera 777"/></a>
                            </div>
                            <h4 class="item-title"><a href="{{ url('DetailProduct/' . $item->id) }}">{{$item->name}}</a></h4>
                            <div class="brand-card">
                                <div class="brand">
                                    <span>Brand <a href="#">{{$item->brand}}</a></span>
                                </div>
	...
	<div class="section">
		<div class="container">
			...
			<div class="row owl-carousel caro-common category-carousel">
                @foreach ($ProductAvailable_Offer as $item)
                    <div class="col-lg-12">
                        <div class="item-card mb30">
                            <div class="item-image">
                                <ul class="labels-list">
                                    ...
                                    <li><a class="addtowishlist" data-id="{{$item->id}}" href="javascript:void(0);"><i class="fa-solid fa-heart"></i></a></li>
                                                            ...
                                                            <a href="{{ url('DetailProduct/' . $item->id) }}"><img src="{{ asset('storage/images/' . $item->image) }}" alt="Touch LED Sports Watch"/></a>
                            </div>
                            <h4 class="item-title"><a href="{{ url('DetailProduct/' . $item->id) }}">{{$item->name}}</a></h4>
                            <div class="brand-card">
                                <div class="brand">
