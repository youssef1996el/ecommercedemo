							...
							<div class="product-list p-3 mb-3">
									...
									<div class="col-sm-6">
										<div class="d-flex align-items-center">
											<div class="product-img">
												<img src=" {{asset('images/chair.png')}}" alt="" />
											</div>
											<div class="ms-2">
								...
								<div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
									<div class="col-sm-6">
										<div class="d-flex align-items-center">
											<div class="product-img">
												<img src=" {{asset('images/user-interface.png')}}" alt="" />
											</div>
											<div class="ms-2">
								...
								<div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
									<div class="col-sm-6">
										<div class="d-flex align-items-center">
											<div class="product-img">
												<img src=" {{asset('images/tshirt.png')}}" alt="" />
											</div>
											<div class="ms-2">
								...
								<div class="row border mx-0 py-2 radius-10 cursor-pointer">
									<div class="col-sm-6">
										<div class="d-flex align-items-center">
											<div class="product-img">
												<img src="{{asset('images/shoes.png')}}" alt="" />
											</div>
											<div class="ms-2">
                                ...
                                @foreach ($users as $item)
                                    <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <p class="mb-0 font-13 text-secondary">{{$item->email}}</p>
                                        </div>
